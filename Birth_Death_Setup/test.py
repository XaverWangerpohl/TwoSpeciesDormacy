...
if __name__ == '__main__':
    ...
    plot_segment(U0, V0, W0, X0, Y0, Z0,W_birth, Y_birth,W_death, Y_death,X_in, X_out,U_in, U_out,Z_in, Z_out,Time=600.0, dt=0.1,use_X=True, use_Z=False,severity=0.5,perturb_W=False, perturb_Y=True,perturb_time=20.0,tol=1e-7)

    # test of run invasion function

    #run_invasion(V0, W0, Y0, W_birth, Y_birth, W_death, Y_death, X_in, X_out,U_in, U_out, Z_in, Z_out,extinction_rate, dt,use_X, use_Z,severity,cycles=10000,perturb_W=False,perturb_Y=True ,plot=True,stop=None,break_threshold=0.1)
